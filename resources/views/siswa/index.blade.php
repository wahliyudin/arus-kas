                        ...
                        <th class="w-10px pe-2">
                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                <input class="form-check-input" type="checkbox" data-kt-check="true"
                                    data-kt-check-target="#siswa_table .form-check-input" value="1" />
                            </div>
                        </th>
...
@push('modal')
    <div class="modal fade" id="create-siswa" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <form class="form" action="#" id="create-siswa_form" data-kt-redirect="../../customers/list.html">
                    <div class="modal-header" id="create-siswa_header">
                        <h2 class="fw-bold">Tambah Siswa</h2>
                        <div id="create-siswa_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                            <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>
                        </div>
                    </div>
                    <div class="modal-body py-10 px-lg-17">
                        <div class="fv-row mb-7">
                            <label class="required fs-6 fw-semibold mb-2">NIS</label>
                    ...
                    <div class="modal-footer flex-center">
                        <button type="reset" id="create-siswa_cancel" class="btn btn-light me-3">
                            Discard
                        </button>
                        <button type="submit" data-akun="" id="create-siswa_submit" class="btn btn-primary">
            ...
            <div class="modal-content">
                <form class="form" action="#" id="import_form">
                    <div class="modal-header" id="import_header">
                        <h2 class="fw-bold">Import Siswa</h2>
...
@push('js')
    ...
    <script src="{{ asset('assets/js/pages/siswa/index.js') }}"></script>
    <script src="{{ asset('assets/js/pages/siswa/create.js') }}"></script>
@endpush
